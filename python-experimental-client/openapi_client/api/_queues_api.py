...
from openapi_client.models import clear_actions_queue_status
from openapi_client.models import clear_messages_queue_status
from openapi_client.models import outbound_actions
from openapi_client.models import outbound_messages
...
class 5QueuesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.clear_actions_queue = Endpoint(
            settings={
                'response_type': (clear_actions_queue_status.ClearActionsQueueStatus,),
                'auth': [
                    'instanceId',
                    'token'
                ],
        ...
        self.clear_messages_queue = Endpoint(
            settings={
                'response_type': (clear_messages_queue_status.ClearMessagesQueueStatus,),
                'auth': [
                    'instanceId',
                    'token'
                ],
        ...
        def __show_actions_queue(
            ...
            **kwargs
            ...
            Returns:
                outbound_actions.OutboundActions
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.show_actions_queue = Endpoint(
            settings={
                'response_type': (outbound_actions.OutboundActions,),
                'auth': [
                    'instanceId',
                    'token'
                ],
        ...
        self.show_messages_queue = Endpoint(
            settings={
                'response_type': (outbound_messages.OutboundMessages,),
                'auth': [
                    'instanceId',
                    'token'
                ],
