...
class SendVCardRequest(ModelNormal):
    ...
    def __init__(self, vcard, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """send_v_card_request.SendVCardRequest - a model defined in OpenAPI
