...
class SendLinkRequest(ModelNormal):
    ...
    attribute_map = {
        'body': 'body',  # noqa: E501
        'preview_base64': 'previewBase64',  # noqa: E501
    ...
    def __init__(self, body, preview_base64, title, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """send_link_request.SendLinkRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Description for send link. [optional]  # noqa: E501
        """
