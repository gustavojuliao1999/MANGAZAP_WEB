...
class SendMessageRequest(ModelNormal):
    ...
    def __init__(self, body, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """send_message_request.SendMessageRequest - a model defined in OpenAPI
