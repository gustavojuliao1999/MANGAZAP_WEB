...
class WebhookUrl(ModelNormal):
    ...
    def __init__(self, webhook_url, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """webhook_url.WebhookUrl - a model defined in OpenAPI
