...
class BanTestAction(ModelNormal):
    ...
    def __init__(self, phone, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """ban_test_action.BanTestAction - a model defined in OpenAPI
