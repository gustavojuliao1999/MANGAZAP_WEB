...
class GroupParticipantAction(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'participant_chat_id': (str,),  # noqa: E501
            'participant_phone': (int,),  # noqa: E501
        }
    ...
    def __init__(self, group_id, participant_chat_id, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """group_participant_action.GroupParticipantAction - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            participant_phone (int): **Required if participantChatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.. [optional]  # noqa: E501
        """
