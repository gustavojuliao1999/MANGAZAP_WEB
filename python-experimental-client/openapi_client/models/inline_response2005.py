...
try:
    from openapi_client.models import inline_response2005_update
except ImportError:
    inline_response2005_update = sys.modules[
        'openapi_client.models.inline_response2005_update']
...
class InlineResponse2005(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'update': (inline_response2005_update.InlineResponse2005Update,),  # noqa: E501
    ...
    def __init__(self, update, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):  # noqa: E501
        """inline_response2005.InlineResponse2005 - a model defined in OpenAPI

        Args:
            update (inline_response2005_update.InlineResponse2005Update):
